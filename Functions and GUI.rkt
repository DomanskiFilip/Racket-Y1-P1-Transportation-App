...
(define (string-to-line start-line-v)
  (cond
    [(equal? start-line-v "Northern Line") (get-stations northern-line)]
        ...
        [(equal? start-line-v "Central Line") (get-stations central-line)]
        [(equal? start-line-v "Circle Line") (get-stations circle-line)]
        [(equal? start-line-v "District Line") (get-stations district-line)]
        [(equal? start-line-v "Hammersmith City Line") (get-stations hammersmith-city-line)]
        [(equal? start-line-v "Jubilee Line") (get-stations jubilee-line)]
        [(equal? start-line-v "Metropolitan Line") (get-stations metropolitan-line)]
        [(equal? start-line-v "Piccadilly Line") (get-stations piccadilly-line)]
        [(equal? start-line-v "Victoria Line") (get-stations victoria-line)]))


(define (get-stations line)
  (printf "Im working")
