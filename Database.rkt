...
(add-edge! northern-line "finchley central to mill hill east" 3)
(add-edge! northern-line "finchley central to east finchley" 4)
...
(add-edge! northern-line "camden town to chalk farm" 2)
...
(add-edge! central-line "west acton" 3)
(add-edge! central-line "north acton" 2)
...
(add-edge! central-line "wanstead" 2)
(add-edge! central-line "redbridge" 3)
(add-edge! central-line "gants hill" 4)
(add-edge! central-line "newbury park" 2)
(add-edge! central-line "barkingside" 2)
(add-edge! central-line "fairlop" 2)
(add-edge! central-line "hainault" 2)
(add-edge! central-line "grange hill" 2)
(add-edge! central-line "chigwell" 4)
(add-edge! central-line "roding valley" 3)
(add-edge! central-line "leytonstone" 3)
...
(add-edge! district-line "gunnersbury"3)
(add-edge! district-line "kew gardens" 3)
(add-edge! district-line "turnham green" 2)
...
(add-edge! district-line "west brompton" 1)
(add-edge! district-line "fulham broadway" 2)
(add-edge! district-line "parsons green" 3)
(add-edge! district-line "putney bridge" 2)
(add-edge! district-line "east putney" 2)
(add-edge! district-line "southfields" 2)
(add-edge! district-line "wimbledon park" 3)
(add-edge! district-line "earls court" 3)
(add-edge! district-line "earls court" 3)
(add-edge! district-line "high street kensington" 2)
(add-edge! district-line "notting hill gate" 2)
(add-edge! district-line "bayswater" 2)
(add-edge! district-line "paddington" 2)
(add-edge! district-line "earls court" 2)
...
(add-edge! metropolitan-line "croxley" 3)
(add-edge! metropolitan-line "moor park" 3)
...
(add-edge! metropolitan-line "west harrow" 3)
(add-edge! metropolitan-line "rayners lane" 2)
(add-edge! metropolitan-line "eastcote" 2)
(add-edge! metropolitan-line "ruislip manor" 2)
(add-edge! metropolitan-line "ruislip" 3)
(add-edge! metropolitan-line "ickenham" 2)
(add-edge! metropolitan-line "hillingdon" 3)
(add-edge! metropolitan-line "harrow-on-the-hill" 3)
...
(add-edge! piccadilly-line "south ealing" 1)
(add-edge! piccadilly-line "northfields" 2)
(add-edge! piccadilly-line "boston manor" 3)
(add-edge! piccadilly-line "osterley" 2)
(add-edge! piccadilly-line "hounslow east" 1)
(add-edge! piccadilly-line "hounslow central" 2)
(add-edge! piccadilly-line "hounslow west" 4)
(add-edge! piccadilly-line "hatton cross" 2)
(add-edge! piccadilly-line "heathrow terminal 4" 5)
(add-edge! piccadilly-line "heathrow terminals 1, 2, 3" 3)
(add-edge! piccadilly-line "acton town" 3)
